...
if not COINCAP_API_KEY:
    raise ValueError("A chave de API COINCAP_API_KEY não foi encontrada no arquivo .env ou nas variáveis de ambiente.")

def get_all_assets_v3(limit=2000):
    """
    Busca uma lista de todos os ativos (criptomoedas) na CoinCap API v3,
    com um limite máximo de 2000 ativos por requisição.
    """
